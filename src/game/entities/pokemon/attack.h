...
bool performAttack(Pokemon &attacker, Pokemon &defender, int attackType, int attackerTurn); // La función que realiza el ataque tomando el atacante, defensor y tipo de ataque y número de turno para verificar si está disponible el ataque especial
